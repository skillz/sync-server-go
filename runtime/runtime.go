...
1. Build Nakama from source:
	go get -d github.com/aaron-skillz/sync-server-go
	cd $GOPATH/src/github.com/aaron-skillz/sync-server-go
...
4. Start Nakama with your module:
	$GOPATH/src/github.com/aaron-skillz/sync-server-go/nakama --runtime.path $GOPATH/src/plugin_project/modules
